...
<div class="panel panel-primary col-md-7 col-xs-offset-3 col-xs-6">
            <div class="panel-heading"><center>Add Service</center></div>
...
move_uploaded_file($_FILES["image"]["tmp_name"],"C:/xampp/htdocs/construction/img/services/".$imgnewfile);
// Query for insertion data into database  
$imagefileappend=$path.$imgnewfile;
$query=mysqli_query($con,"insert into services(service_name,service_info,service_pic) values('$imgtitle','$descp','$imagefileappend') ");
if($query)
{
