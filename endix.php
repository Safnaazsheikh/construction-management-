...
<nav id="menu" class="navbar navbar-default navbar-fixed-top">
  <div class="container"> 
    ...
    <div class="navbar-header">
      ...
      <a class="navbar-brand page-scroll" href="#page-top">CONSTRUCTO</a>
...
<div id="services">
 ...
 while ($item = $result->fetch_array()) {
	...
	//$img = echo '<img src="data:image/jpeg;base64,'.base64_encode( $result['image'] ).'"/>';
	
echo '<div class="'.$col_class.'"><div class="'.$service_media.'"><img src="data:image/jpeg;base64,'.base64_encode( $item['service_pic'] ).'"/></div><div class="'.$service_desc.'">
