...
<nav id="menu" class="navbar navbar-default navbar-fixed-top">
  <div class="container"> 
    ...
    <div class="navbar-header">
      ...
      <div class="phone"><span>Call Today</span>+91 7411434210</div>
    </div>
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav navbar-right">
		...
		<li><a href="#" class="dropdown-toggle" data-toggle="dropdown"><span class="glyphicon glyphicon-user"></span><?php echo "Hi, ".$_SESSION["email"]; ?></a>
					  <ul class="dropdown-menu " role="menu" id="it">
                        <li><a href="testimonial.php"><b>Write Testimonial?</b></a></li>
               ...
               <!-- <li class="dropdown ">
                    <a href="" class="dropdown-toggle " data-toggle="dropdown" data-hover="dropdown "><i class="fa fa-user"></i><span>Register</span></a>
                    <ul class="dropdown-menu " role="menu" id="it">
                        <li><a href="stdregister.php"><b>Contracror Register</b></a></li>
                        <li><a href="facultyregistration.php"><b>Builder Register</b></a></li>
    ...
    <div class="row">
      ...
      <div class="col-xs-12 col-md-6">
        <div class="about-text">
          <h2>Who We Are</h2>
          <p>P.A Mendes is a Construction Company Based in Ponda-Goa, We undertake contracts for Appartments,Villas,Row Houses,Buildings and make a Dream Home for you, We have 10 years of experience in the field of Constructon and providing the best available services.</p>
          <h3>Why Choose Us?</h3>
...
<div id="testimonials">
  <div class="container">
	...
	<?php
	$sql="SELECT * FROM testimonial ORDER BY t_id DESC LIMIT 6";
	if (!$result = $con->query($sql)) {
    	die ('There was an error running query[' . $con->error . ']');
	}	
	$rows = $result->num_rows;
  ...
  <div class="container">
    ...
    <div class="col-md-3 col-md-offset-1 contact-info">
      <div class="contact-item">
        <h4>Contact Info</h4>
        <p><span>Address</span>H.no 1880 Kurismol <br>
          Holy Cross, Ponda 403401 </p>
      </div>
      <div class="contact-item">
        <p><span>Phone</span> +91 7411434210</p>
      </div>
      <div class="contact-item">
        <p><span>Email</span> info@mendes.com</p>
      </div>
    </div>
    <div class="col-md-12">
      <div class="row">
